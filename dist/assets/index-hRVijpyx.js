(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))o(s);new MutationObserver(s=>{for(const c of s)if(c.type==="childList")for(const d of c.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&o(d)}).observe(document,{childList:!0,subtree:!0});function a(s){const c={};return s.integrity&&(c.integrity=s.integrity),s.referrerPolicy&&(c.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?c.credentials="include":s.crossOrigin==="anonymous"?c.credentials="omit":c.credentials="same-origin",c}function o(s){if(s.ep)return;s.ep=!0;const c=a(s);fetch(s.href,c)}})();const r=[{id:"emerald",title:"Emerald 翡翠",subtitle:"复古 / 沉静 / 高级",tags:["#复古","#沉静","#高级"],note:"冷静、克制的经典复古绿调。",colors:["#D5E3D2","#003153","#0A3D2E"],colorNames:["米白色","普鲁士蓝","墨绿"],surface:"#10281f",accent:"#dbe8d8"},{id:"ruby",title:"Ruby 红宝",subtitle:"浓郁 / 戏剧 / 怀旧",tags:["#浓郁","#戏剧","#怀旧"],note:"高对比红蓝组合，戏剧感强。",colors:["#E6DDD1","#203850","#7A1F2B"],colorNames:["米白色","深靛蓝","深酒红"],surface:"#24131b",accent:"#f1e8dd"},{id:"temple",title:"Temple 庙街",subtitle:"温暖 / 复古 / 港味",tags:["#温暖","#复古","#港味"],note:"暖橙与墨绿，港风复古气质明显。",colors:["#E8DED0","#26473E","#B86B2E"],colorNames:["象牙白","墨绿色","琥珀橙"],surface:"#2a2118",accent:"#f2e7d8"},{id:"plum",title:"Plum 梅子",subtitle:"神秘 / 优雅 / 文艺",tags:["#神秘","#优雅","#文艺"],note:"紫调与深海蓝组合，安静且文艺。",colors:["#E8E2D7","#233E5A","#69456B"],colorNames:["燕麦白","深海蓝","柿子紫"],surface:"#201a22",accent:"#efe8df"},{id:"coral",title:"Coral 珊瑚",subtitle:"鲜活 / 年轻 / 复古",tags:["#鲜活","#年轻","#复古"],note:"更鲜活的红绿对比，适合年轻表达。",colors:["#EFE5D7","#28504D","#C85B4A"],colorNames:["奶油白","深松石绿","珊瑚红"],surface:"#2a201b",accent:"#f4ebde"},{id:"harbor",title:"Harbor 港口",subtitle:"理性 / 国际 / 都市",tags:["#理性","#国际","#都市"],note:"偏理性的都市蓝灰方案，适合信息型界面。",colors:["#E3E2DB","#2F3137","#2A4C8B"],colorNames:["云雾白","深墨灰","钴蓝"],surface:"#1e222b",accent:"#ecebe4"},{id:"rose",title:"Rose 蔷薇",subtitle:"浪漫 / 复古 / 精致",tags:["#浪漫","#复古","#精致"],note:"柔和蔷薇调，更偏精致与浪漫。",colors:["#EEDFD4","#6F4A52","#A55C66"],colorNames:["米杏白","玫瑰褐","蔷薇红"],surface:"#2a2024",accent:"#f5e8df"},{id:"teal",title:"Teal 青碧",subtitle:"冷静 / 高级 / 东方",tags:["#冷静","#高级","#东方"],note:"东方语境下的青碧与深咖灰，更耐看。",colors:["#E3E5DD","#403A38","#0D6B67"],colorNames:["月白色","深咖灰","青碧色"],surface:"#22211f",accent:"#eceee6"},{id:"mustard",title:"Mustard 芥末",subtitle:"怀旧 / 浓郁 / 艺术",tags:["#怀旧","#浓郁","#艺术"],note:"芥末黄与墨蓝的组合，艺术感强。",colors:["#E7E0D5","#263D5A","#A88B2C"],colorNames:["亚麻白","墨蓝色","芥末黄"],surface:"#2a261b",accent:"#f0eadf"}],i=document.querySelector("#app");if(!i)throw new Error("App container not found");var n;const l={selectedId:((n=r[0])==null?void 0:n.id)??""},u=()=>r.find(t=>t.id===l.selectedId)??r[0],_=()=>r.map(e=>{const t=e.id===l.selectedId?"is-active":"",[a=e.title,o=""]=e.title.split(" "),s=e.tags.slice(0,3).join(" ");return`
      ...
      `}).join(""),v=e=>e.tags.map(t=>`<span class="chip">${t}</span>`).join(""),f=e=>e.colors.map((t,a)=>`
        <button class="color-row" type="button" data-copy-color="${t}" aria-label="复制色值 ${t}（${e.colorNames[a]}）">
          <span class="color-row__index">0${a+1}</span>
          <span class="color-row__chip" style="background:${t}"></span>
          <span class="color-row__value">${t} · ${e.colorNames[a]}</span>
          <span class="color-row__action">复制</span>
        </button>
      `).join(""),p=()=>{const e=u(),t=e.brand?`<span class="preview__brand">${e.brand}</span>`:"";i.innerHTML=`
    <main class="shell">
      <section class="hero">
        <div class="hero__copy">
          <p class="eyebrow">Color Palette Gallery</p>
          <h1>${r.length} 套复古气质配色</h1>
        </div>
  ...
  `,i.querySelectorAll("[data-palette-id]").forEach(a=>{a.addEventListener("click",()=>{l.selectedId=a.dataset.paletteId??l.selectedId,p()})}),i.querySelectorAll("[data-copy-color]").forEach(a=>{a.addEventListener("click",async()=>{const o=a.dataset.copyColor;if(o)try{await navigator.clipboard.writeText(o),a.classList.add("is-copied"),window.setTimeout(()=>a.classList.remove("is-copied"),900)}catch{window.alert(`已选中：${o}`)}})})};p();
